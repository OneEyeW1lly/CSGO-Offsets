...
dwEntityList = (0x4da2e24)
dwForceAttack = (0x31d43b4)
dwForceAttack2 = (0x31d43c0)
dwForceBackward = (0x31d436c)
dwForceForward = (0x31d4378)
dwForceJump = (0x524cd84)
dwForceLeft = (0x31d4390)
dwForceRight = (0x31d4384)
dwGameDir = (0x62d7f8)
dwGameRulesProxy = (0x52c006c)
dwGetAllClasses = (0xdb2d7c)
dwGlobalVars = (0x58ece8)
dwGlowObjectManager = (0x52eb418)
dwInput = (0x51f4408)
dwInterfaceLinkList = (0x945994)
dwLocalPlayer = (0xd8b2bc)
dwMouseEnable = (0xd90e60)
dwMouseEnablePtr = (0xd90e30)
dwPlayerResource = (0x31d26e0)
dwRadarBase = (0x51d7b9c)
dwSensitivity = (0xd90cfc)
dwSensitivityPtr = (0xd90cd0)
dwSetClanTag = (0x8a1a0)
dwViewMatrix = (0x4d94724)
dwWeaponTable = (0x51f4ec8)
dwWeaponTableIndex = (0x325c)
dwYawPtr = (0xd90ac0)
dwZoomSensitivityRatioPtr = (0xd95d60)
dwbSendPackets = (0xd73ca)
dwppDirect3DDevice9 = (0xa7050)
find_hud_element = (0x3c1eeed0)
