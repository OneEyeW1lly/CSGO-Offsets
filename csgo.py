...
dwEntityList = (0x4d9ea44)
dwForceAttack = (0x31cffa4)
dwForceAttack2 = (0x31cffb0)
dwForceBackward = (0x31cfff8)
dwForceForward = (0x31d0004)
dwForceJump = (0x52489a4)
dwForceLeft = (0x31cff80)
dwForceRight = (0x31cff74)
dwGameDir = (0x62c7f8)
dwGameRulesProxy = (0x52bbc9c)
dwGetAllClasses = (0xdaebe4)
dwGlobalVars = (0x58dce8)
dwGlowObjectManager = (0x52e7038)
dwInput = (0x51f0028)
dwInterfaceLinkList = (0x943064)
dwLocalPlayer = (0xd8722c)
dwMouseEnable = (0xd8cdd0)
dwMouseEnablePtr = (0xd8cda0)
dwPlayerResource = (0x31ce300)
dwRadarBase = (0x51d37bc)
dwSensitivity = (0xd8cc6c)
dwSensitivityPtr = (0xd8cc40)
dwSetClanTag = (0x8a1a0)
dwViewMatrix = (0x4d90344)
dwWeaponTable = (0x51f0ae8)
dwWeaponTableIndex = (0x325c)
dwYawPtr = (0xd8ca30)
dwZoomSensitivityRatioPtr = (0xd91cd0)
dwbSendPackets = (0xd70ca)
dwppDirect3DDevice9 = (0xa7050)
find_hud_element = (0x36eded20)
force_update_spectator_glow = (0x3ae0c2)
interface_engine_cvar = (0x3e9ec)
is_c4_owner = (0x3baba0)
m_bDormant = (0xed)
m_flSpawnTime = (0xa370)
m_pStudioHdr = (0x294c)
m_pitchClassPtr = (0x51d3a58)
