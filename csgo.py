...
dwGameDir = (0x628800)
dwGameRulesProxy = (0x52c22ec)
dwGetAllClasses = (0xdb4ff4)
dwGlobalVars = (0x589ce8)
dwGlowObjectManager = (0x52ed6a8)
dwInput = (0x51f67e0)
dwInterfaceLinkList = (0x947774)
dwLocalPlayer = (0xd8d2cc)
dwMouseEnable = (0xd92e70)
dwMouseEnablePtr = (0xd92e40)
dwPlayerResource = (0x31d4ad0)
dwRadarBase = (0x51d9f94)
dwSensitivity = (0xd92d0c)
dwSensitivityPtr = (0xd92ce0)
dwSetClanTag = (0x8a1b0)
dwViewMatrix = (0x4d96b34)
dwWeaponTable = (0x51f72a0)
dwWeaponTableIndex = (0x325c)
dwYawPtr = (0xd92ad0)
dwZoomSensitivityRatioPtr = (0xd97d70)
dwbSendPackets = (0xd76ca)
dwppDirect3DDevice9 = (0xa7050)
find_hud_element = (0x283bf5a0)
force_update_spectator_glow = (0x3af9fa)
interface_engine_cvar = (0x3e9ec)
is_c4_owner = (0x3bc630)
m_bDormant = (0xed)
m_flSpawnTime = (0xa370)
m_pStudioHdr = (0x294c)
m_pitchClassPtr = (0x51da230)
m_yawClassPtr = (0xd92ad0)
model_ambient_min = (0x58d05c)
set_abs_angles = (0x1e07a0)
set_abs_origin = (0x1e05e0)
