...
dwEntityList = (0x4da1f24)
dwForceAttack = (0x31d3460)
dwForceAttack2 = (0x31d346c)
dwForceBackward = (0x31d349c)
dwForceForward = (0x31d3478)
dwForceJump = (0x524be84)
dwForceLeft = (0x31d3490)
dwForceRight = (0x31d34b4)
dwGameDir = (0x62d7f8)
dwGameRulesProxy = (0x52bf16c)
dwGetAllClasses = (0xdb1f8c)
dwGlobalVars = (0x58ece8)
dwGlowObjectManager = (0x52ea520)
dwInput = (0x51f3508)
dwInterfaceLinkList = (0x945544)
dwLocalPlayer = (0xd8a2bc)
dwMouseEnable = (0xd8fe60)
dwMouseEnablePtr = (0xd8fe30)
dwPlayerResource = (0x31d17e0)
dwRadarBase = (0x51d6c9c)
dwSensitivity = (0xd8fcfc)
dwSensitivityPtr = (0xd8fcd0)
dwSetClanTag = (0x8a1a0)
dwViewMatrix = (0x4d93824)
dwWeaponTable = (0x51f3fc8)
dwWeaponTableIndex = (0x325c)
dwYawPtr = (0xd8fac0)
dwZoomSensitivityRatioPtr = (0xd94d60)
dwbSendPackets = (0xd73ea)
dwppDirect3DDevice9 = (0xa7050)
find_hud_element = (0x359ee320)
...
m_pStudioHdr = (0x294c)
m_pitchClassPtr = (0x51d6f38)
m_yawClassPtr = (0xd8fac0)
