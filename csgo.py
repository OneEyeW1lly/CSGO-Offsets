...
dwGameDir = (0x62d7f8)
dwGameRulesProxy = (0x52c119c)
dwGetAllClasses = (0xdb3f9c)
dwGlobalVars = (0x58ece8)
dwGlowObjectManager = (0x52ec550)
dwInput = (0x51f5540)
dwInterfaceLinkList = (0x946b44)
dwLocalPlayer = (0xd8c2cc)
dwMouseEnable = (0xd91e70)
dwMouseEnablePtr = (0xd91e40)
dwPlayerResource = (0x31d3810)
dwRadarBase = (0x51d8cd4)
dwSensitivity = (0xd91d0c)
dwSensitivityPtr = (0xd91ce0)
dwSetClanTag = (0x8a1b0)
dwViewMatrix = (0x4d95874)
dwWeaponTable = (0x51f6000)
dwWeaponTableIndex = (0x325c)
dwYawPtr = (0xd91ad0)
dwZoomSensitivityRatioPtr = (0xd96d70)
dwbSendPackets = (0xd749a)
dwppDirect3DDevice9 = (0xa7050)
find_hud_element = (0x3661e320)
...
m_pStudioHdr = (0x294c)
m_pitchClassPtr = (0x51d8f70)
m_yawClassPtr = (0xd91ad0)
