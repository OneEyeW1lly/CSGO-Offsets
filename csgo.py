...
dwGameDir = (0x62d7f8)
dwGameRulesProxy = (0x52bdf9c)
dwGetAllClasses = (0xdb0d6c)
dwGlobalVars = (0x58ece8)
dwGlowObjectManager = (0x52e9348)
dwInput = (0x51f2338)
dwInterfaceLinkList = (0x945174)
dwLocalPlayer = (0xd892ac)
dwMouseEnable = (0xd8ee50)
dwMouseEnablePtr = (0xd8ee20)
dwPlayerResource = (0x31d0610)
dwRadarBase = (0x51d5acc)
dwSensitivity = (0xd8ecec)
dwSensitivityPtr = (0xd8ecc0)
dwSetClanTag = (0x8a1a0)
dwViewMatrix = (0x4d92654)
dwWeaponTable = (0x51f2df8)
dwWeaponTableIndex = (0x325c)
dwYawPtr = (0xd8eab0)
dwZoomSensitivityRatioPtr = (0xd93d50)
dwbSendPackets = (0xd73ea)
dwppDirect3DDevice9 = (0xa7050)
find_hud_element = (0x3be1e0c0)
force_update_spectator_glow = (0x3ad6e2)
interface_engine_cvar = (0x3e9ec)
is_c4_owner = (0x3ba1c0)
m_bDormant = (0xed)
m_flSpawnTime = (0xa370)
m_pStudioHdr = (0x294c)
m_pitchClassPtr = (0x51d5d68)
m_yawClassPtr = (0xd8eab0)
model_ambient_min = (0x59205c)
set_abs_angles = (0x1df810)
set_abs_origin = (0x1df650)
