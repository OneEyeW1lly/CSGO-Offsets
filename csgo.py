...
dwEntityList = (0x4da4f8c)
dwForceAttack = (0x31d6514)
dwForceAttack2 = (0x31d6520)
dwForceBackward = (0x31d64cc)
dwForceForward = (0x31d64d8)
dwForceJump = (0x524eecc)
dwForceLeft = (0x31d64f0)
dwForceRight = (0x31d64e4)
dwGameDir = (0x628800)
dwGameRulesProxy = (0x52c21ac)
dwGetAllClasses = (0xdb4f8c)
dwGlobalVars = (0x589ce8)
dwGlowObjectManager = (0x52ed560)
dwInput = (0x51f6550)
dwInterfaceLinkList = (0x947d24)
dwLocalPlayer = (0xd8d2bc)
dwMouseEnable = (0xd92e60)
dwMouseEnablePtr = (0xd92e30)
dwPlayerResource = (0x31d4840)
dwRadarBase = (0x51d9d04)
dwSensitivity = (0xd92cfc)
dwSensitivityPtr = (0xd92cd0)
dwSetClanTag = (0x8a1b0)
dwViewMatrix = (0x4d968a4)
dwWeaponTable = (0x51f7010)
dwWeaponTableIndex = (0x325c)
dwYawPtr = (0xd92ac0)
dwZoomSensitivityRatioPtr = (0xd97d60)
dwbSendPackets = (0xd75ea)
dwppDirect3DDevice9 = (0xa7050)
find_hud_element = (0x32c0ea20)
force_update_spectator_glow = (0x3aee0a)
interface_engine_cvar = (0x3e9ec)
is_c4_owner = (0x3bb960)
m_bDormant = (0xed)
m_flSpawnTime = (0xa370)
m_pStudioHdr = (0x294c)
m_pitchClassPtr = (0x51d9fa0)
m_yawClassPtr = (0xd92ac0)
model_ambient_min = (0x58d05c)
set_abs_angles = (0x1dfc70)
set_abs_origin = (0x1dfab0)
