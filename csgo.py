...
dwForceAttack2 = (0x31d54e8)
dwForceBackward = (0x31d5530)
dwForceForward = (0x31d553c)
dwForceJump = (0x524dedc)
dwForceLeft = (0x31d5554)
dwForceRight = (0x31d5548)
dwGameDir = (0x6277f8)
dwGameRulesProxy = (0x52c11bc)
dwGetAllClasses = (0xdb3f8c)
dwGlobalVars = (0x588ce8)
dwGlowObjectManager = (0x52ec580)
dwInput = (0x51f5560)
dwInterfaceLinkList = (0x946f44)
dwLocalPlayer = (0xd8c2bc)
dwMouseEnable = (0xd91e60)
dwMouseEnablePtr = (0xd91e30)
dwPlayerResource = (0x31d3850)
dwRadarBase = (0x51d8d14)
dwSensitivity = (0xd91cfc)
dwSensitivityPtr = (0xd91cd0)
dwSetClanTag = (0x8a1b0)
dwViewMatrix = (0x4d958b4)
dwWeaponTable = (0x51f6020)
dwWeaponTableIndex = (0x325c)
dwYawPtr = (0xd91ac0)
dwZoomSensitivityRatioPtr = (0xd96d60)
dwbSendPackets = (0xd749a)
dwppDirect3DDevice9 = (0xa7050)
find_hud_element = (0x2da9e320)
force_update_spectator_glow = (0x3ae412)
interface_engine_cvar = (0x3e9ec)
is_c4_owner = (0x3baf00)
m_bDormant = (0xed)
m_flSpawnTime = (0xa370)
m_pStudioHdr = (0x294c)
m_pitchClassPtr = (0x51d8fb0)
m_yawClassPtr = (0xd91ac0)
model_ambient_min = (0x58c05c)
