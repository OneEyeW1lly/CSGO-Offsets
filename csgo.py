...
dwGameDir = (0x62c7f8)
dwGameRulesProxy = (0x52702b4)
dwGetAllClasses = (0xd653a4)
dwGlobalVars = (0x58dce8)
dwGlowObjectManager = (0x529b210)
dwInput = (0x51a4978)
dwInterfaceLinkList = (0x906154)
dwLocalPlayer = (0xd3ed14)
dwMouseEnable = (0xd448b8)
dwMouseEnablePtr = (0xd44888)
dwPlayerResource = (0x3182c80)
dwRadarBase = (0x518810c)
dwSensitivity = (0xd44754)
dwSensitivityPtr = (0xd44728)
dwSetClanTag = (0x8a0e0)
dwViewMatrix = (0x4d44cc4)
dwWeaponTable = (0x51a543c)
dwWeaponTableIndex = (0x325c)
dwYawPtr = (0xd44518)
dwZoomSensitivityRatioPtr = (0xd497b8)
dwbSendPackets = (0xd6e5a)
dwppDirect3DDevice9 = (0xa7050)
find_hud_element = (0x34b12860)
force_update_spectator_glow = (0x3a1a32)
interface_engine_cvar = (0x3e9ec)
is_c4_owner = (0x3ae4d0)
m_bDormant = (0xed)
m_flSpawnTime = (0xa370)
m_pStudioHdr = (0x294c)
m_pitchClassPtr = (0x51883b0)
m_yawClassPtr = (0xd44518)
model_ambient_min = (0x59105c)
set_abs_angles = (0x1d4fa0)
set_abs_origin = (0x1d4de0)
