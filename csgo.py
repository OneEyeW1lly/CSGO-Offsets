...
dwGameDir = (0x628800)
dwGameRulesProxy = (0x52c42ec)
dwGetAllClasses = (0xdb601c)
dwGlobalVars = (0x589ce8)
dwGlowObjectManager = (0x52ef6c8)
dwInput = (0x51f87d0)
dwInterfaceLinkList = (0x947bf4)
dwLocalPlayer = (0xd8e2cc)
dwMouseEnable = (0xd93e70)
dwMouseEnablePtr = (0xd93e40)
dwPlayerResource = (0x31d5ac0)
dwRadarBase = (0x51dbf84)
dwSensitivity = (0xd93d0c)
dwSensitivityPtr = (0xd93ce0)
dwSetClanTag = (0x8a1b0)
dwViewMatrix = (0x4d98b24)
dwWeaponTable = (0x51f9290)
dwWeaponTableIndex = (0x325c)
dwYawPtr = (0xd93ad0)
dwZoomSensitivityRatioPtr = (0xd98d70)
dwbSendPackets = (0xd779a)
dwppDirect3DDevice9 = (0xa7050)
find_hud_element = (0x3018fa00)
force_update_spectator_glow = (0x3afdfa)
interface_engine_cvar = (0x3e9ec)
is_c4_owner = (0x3bca40)
m_bDormant = (0xed)
m_flSpawnTime = (0xa370)
m_pStudioHdr = (0x294c)
m_pitchClassPtr = (0x51dc220)
m_yawClassPtr = (0xd93ad0)
