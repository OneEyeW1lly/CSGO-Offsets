...
dwEntityList = (0x4d9eae4)
dwForceAttack = (0x31d0044)
dwForceAttack2 = (0x31d0050)
dwForceBackward = (0x31d0098)
dwForceForward = (0x31d00a4)
dwForceJump = (0x5248a44)
dwForceLeft = (0x31d0020)
dwForceRight = (0x31d0014)
dwGameDir = (0x62c7f8)
dwGameRulesProxy = (0x52bbd3c)
dwGetAllClasses = (0xdaec94)
dwGlobalVars = (0x58dce8)
dwGlowObjectManager = (0x52e70e8)
dwInput = (0x51f00c8)
dwInterfaceLinkList = (0x943334)
dwLocalPlayer = (0xd8722c)
dwMouseEnable = (0xd8cdd0)
dwMouseEnablePtr = (0xd8cda0)
dwPlayerResource = (0x31ce3a0)
dwRadarBase = (0x51d385c)
dwSensitivity = (0xd8cc6c)
dwSensitivityPtr = (0xd8cc40)
dwSetClanTag = (0x8a1a0)
dwViewMatrix = (0x4d903e4)
dwWeaponTable = (0x51f0b88)
dwWeaponTableIndex = (0x325c)
dwYawPtr = (0xd8ca30)
dwZoomSensitivityRatioPtr = (0xd91cd0)
dwbSendPackets = (0xd70fa)
dwppDirect3DDevice9 = (0xa7050)
find_hud_element = (0x3678ed20)
